(function () {
    ...
    let meuH3 = document.querySelector("body h3");
    ...
    class Fruit {
        ...
        take() {
            document.querySelector(`#board tr:nth-child(${this.position[0]}) td:nth-child(${this.position[1]})`).style.backgroundColor = snake.color;
        }
    ...
    class Snake {
        constructor() {
            ...
            for (let i = 0; i < this.corpoX.length; i++) {
                document.querySelector(`#board tr:nth-child(${this.corpoX[i]}) td:nth-child(${this.corpoY[i]})`).style.backgroundColor = this.cor;
            }
        }
        ...
        andar() {
            ...
            let head = [this.corpoX[this.corpoX.length - 1], this.corpoY[this.corpoY.length - 1]];
            let add;
            ...
            if (this.isOutOfBounds(add) || this.isOnSnakeBody(add)) return this.lost = true;
            ...
            if (this.onFruit(head)) fruit.eat();
                ...
                document.querySelector(`#board tr:nth-child(${remX}) td:nth-child(${remY})`).style.backgroundColor = board.cor;
            }
        }
        ...
        onFruit = (head) => head[0] == fruit.position[0] && head[1] == fruit.position[1] ? true : false;
        ...
        isOutOfBounds = (add) => add[0] > 40 || add[0] < 1 || add[1] > 40 || add[1] < 1 ? true : false;
